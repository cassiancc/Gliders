...
public class GliderModel extends EntityModel<HumanoidRenderState> {
    ...
    public void setupAnim(HumanoidRenderState entity) {
        if (entity instanceof LivingEntityRenderState livingEntity) {
            ...
            if (!GliderUtil.isGlidingWithActiveGlider(livingEntity)) return;
            ...
            if (GliderUtil.isGlidingWithActiveGlider(livingEntity)) {
                ...
                if (animation != null) {
                    this.opening.apply(animation, entity.ageInTicks);
                }
            }
        }
    }
